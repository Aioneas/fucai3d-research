...
BASE_SCRIPT = '/var/minis/workspace/build_fucai3d_dataset.py'
SRC = Path('/var/minis/offloads/browser_use_1776018948_call_vbi.txt')
...
spec = importlib.util.spec_from_file_location('f3d_base', BASE_SCRIPT)
mod = importlib.util.module_from_spec(spec)
spec.loader.exec_module(mod)

text = SRC.read_text(encoding='utf-8')
raw_records = mod.parse_offload(text)
...
features = mod.build_feature_rows(full)
train = [
    {
        'issue': r['issue'],
        'date': r['date'],
...
summary = {
    ...
    'lottery': '福彩3D',
    'requested_dayStart': '2004-01-01',
    'requested_dayEnd': '2026-04-13',
